...
namespace WPFGame.Data
{
    ...
    {
        public Animations() { }
        public readonly List<string> CharacterRun = new List<string>
        {
        ...
        public readonly List<string> CharacterIdle = new List<string>
        {
        ...
        public readonly List<string> CharacterJump = new List<string>
        {
        ...
        public readonly List<string> CharacterAtk = new List<string>
        {
        ...
        public readonly List<string> WereWRun = new List<string>
        {
        ...
        public readonly List<string> WereWIdle = new List<string>
        {
        ...
        public readonly List<string> WereWAtk = new List<string>
        {
        ...
        public readonly List<string> HoundRun = new List<string>
        {
        ...
        public readonly List<string> HoundIdle = new List<string>
        {
        ...
        public readonly List<string> HoundAtk = new List<string>
        {
